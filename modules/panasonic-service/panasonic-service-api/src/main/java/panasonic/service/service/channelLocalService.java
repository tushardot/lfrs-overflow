...
/**
 * Provides the local service interface for channel. Methods of this
 * service will not have security checks based on the propagated JAAS
 * credentials because this service can only be accessed from within the same
 * VM.
 *
 * @author Brian Wing Shun Chan
 * @see channelLocalServiceUtil
 * @generated
 */
@ProviderType
@Transactional(
...
public interface channelLocalService
	extends BaseLocalService, PersistedModelLocalService {

	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify this interface directly. Add custom service methods to <code>panasonic.service.service.impl.channelLocalServiceImpl</code> and rerun ServiceBuilder to automatically copy the method declarations to this interface. Consume the channel local service via injection or a <code>org.osgi.util.tracker.ServiceTracker</code>. Use {@link channelLocalServiceUtil} if injection and service tracking are not available.
	 */
