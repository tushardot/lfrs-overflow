...
/**
 * Provides the local service interface for support. Methods of this
 * service will not have security checks based on the propagated JAAS
 * credentials because this service can only be accessed from within the same
 * VM.
 *
 * @author Brian Wing Shun Chan
 * @see supportLocalServiceUtil
 * @generated
 */
@ProviderType
@Transactional(
...
public interface supportLocalService
	 ...
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify this interface directly. Add custom service methods to <code>com.liferay.customer.support.service.impl.supportLocalServiceImpl</code> and rerun ServiceBuilder to automatically copy the method declarations to this interface. Consume the support local service via injection or a <code>org.osgi.util.tracker.ServiceTracker</code>. Use {@link supportLocalServiceUtil} if injection and service tracking are not available.
	 */
	...
	public support createsupportinfo(
