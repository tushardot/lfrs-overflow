...
public interface answerLocalService
	 ...
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify this interface directly. Add custom service methods to <code>queries.service.service.impl.answerLocalServiceImpl</code> and rerun ServiceBuilder to automatically copy the method declarations to this interface. Consume the answer local service via injection or a <code>org.osgi.util.tracker.ServiceTracker</code>. Use {@link answerLocalServiceUtil} if injection and service tracking are not available.
	 */
