 ...
 * <code>queries.service.service.impl.questionLocalServiceImpl</code> and
...
public class questionLocalServiceUtil {
	 ...
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify this class directly. Add custom service methods to <code>queries.service.service.impl.questionLocalServiceImpl</code> and rerun ServiceBuilder to regenerate this class.
	 */
	 ...
	 */
	public static question createquestion(long quesId) {
		return getService().createquestion(quesId);
	}
	 ...
	 */
	public static question deletequestion(long quesId) throws PortalException {
		return getService().deletequestion(quesId);
	}
	...
	public static question fetchquestion(long quesId) {
		return getService().fetchquestion(quesId);
	}
	 ...
	 * @throws PortalException if a question with the primary key could not be found
	 */
	public static question getquestion(long quesId) throws PortalException {
		return getService().getquestion(quesId);
	}
